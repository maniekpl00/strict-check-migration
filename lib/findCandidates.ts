...
const appRootPath = configs.appRootPath;
const tsconfigPath = configs.tsconfigPath;
const srcRoot = configs.srcPath;
...
async function findCandidates() {
  const checkedFiles = await getCheckedFiles(tsconfigPath, appRootPath);
